...
def cli_insert():
	...
	result = request.post(config.ADDR + globs.my_ip + ":" + globs.my_port + "/chord/insert_song", data = pair)
	return result
	# pass
...
def cli_delete():
	pair = request.form.to_dict()
	result = request.post(config.ADDR + globs.my_ip + ":" + globs.my_port + "/chord/delete_song", data = pair)
	return result
	# pass
...
def cli_query():
	pair = request.form.to_dict()
	result = request.post(config.ADDR + globs.my_ip + ":" + globs.my_port + "/chord/query_song", data = pair)
	return result
	# pass
